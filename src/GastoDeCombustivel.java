...
public class GastoDeCombustivel {
    public static void main(String[] args)
    {
        ...
        int tempoGastoViagemHoras = input.nextInt();
        int velocidadeMediaEmKm = input.nextInt();

        double combustivelNecessario = (double) (tempoGastoViagemHoras * velocidadeMediaEmKm) / 12;
